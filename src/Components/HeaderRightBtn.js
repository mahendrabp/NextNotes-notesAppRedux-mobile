...
import {getNotes, getSearchNotes, changeSort} from '../redux/action/notes';
...
class HeaderRightBtn extends React.Component {
  ...
  hideMenu = sort => {
    ...
    this.props.notes.searchKeyword !== ''
      ? this.props.dispatch(
          getSearchNotes(this.props.notes.searchKeyword, 1, sort),
        )
      : this.props.dispatch(
          getNotes(
            this.props.notes.searchKeyword,
  ...
  render() {
    return (
      <Menu
        ...
        <MenuItem
          onPress={() => this.hideMenu('ASC')}
          textStyle={styles.MenuItems}>
          ASCENDING
        </MenuItem>
        <MenuItem
          onPress={() => this.hideMenu('DESC')}
          textStyle={styles.MenuItems}>
          DESCENDING
        </MenuItem>
      </Menu>
